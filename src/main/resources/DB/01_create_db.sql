...
-- -----------------------------------------------------
-- Table `fitness_club_db`.`inbody_analyzes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`inbody_analyzes` (
  `id_inbody_analysis` INT NOT NULL AUTO_INCREMENT,
  `height` FLOAT NULL,
  `weight` FLOAT NULL,
  `bmi` FLOAT NULL,
  `fat_percent` FLOAT NULL,
  `muscle_persent` FLOAT NULL,
  PRIMARY KEY (`id_inbody_analysis`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `fitness_club_db`.`members_have_inbody_analyzes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`members_have_inbody_analyzes` (
  `id_member` INT NOT NULL,
  `id_inbody_analysies` INT NOT NULL,
  PRIMARY KEY (`id_member`, `id_inbody_analysies`),
  INDEX `fk_members_has_inbody_analyses_inbody_analyses1_idx` (`id_inbody_analysies` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_members_has_inbody_analyses_inbody_analyses1`
    FOREIGN KEY (`id_inbody_analysies`)
    REFERENCES `fitness_club_db`.`inbody_analyzes` (`id_inbody_analysis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
