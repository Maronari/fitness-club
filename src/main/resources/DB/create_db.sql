...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`users_photo` (
  ...
  PRIMARY KEY (`id_photo`, `id_member`, `username`),
  INDEX `fk_users_photo_members_accounts1_idx` (`id_member` ASC, `username` ASC) VISIBLE,
  CONSTRAINT `fk_users_photo_members_accounts1`
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`trainers_accounts` (
  ...
  `account_creation_date` DATE NOT NULL,
  `user_role` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id_trainer`, `trainer_username`),
