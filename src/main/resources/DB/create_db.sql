...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`membership_role` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`clubs` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`position` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`staff` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`equipment_type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`equipment` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`trainers` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`gyms` ;
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`gyms` (
  ...
  PRIMARY KEY (`id_gym`, `clubs_name`),
  INDEX `fk_gyms_clubs1_idx` (`clubs_name` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`activity_type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`equipment_statistics` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`inbody_analyses` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`training_type` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`training_schedule` ;
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`training_schedule` (
  ...
  `training_schedulecol` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`users_photo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_accounts` ;
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`members_accounts` (
  ...
  PRIMARY KEY (`id_member`, `username`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`feedback` ;
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`feedback` (
  ...
  INDEX `fk_feedback_members_accounts1_idx` (`id_member` ASC, `username` ASC) VISIBLE,
  CONSTRAINT `fk_feedback_members_accounts1`
    FOREIGN KEY (`id_member` , `username`)
    REFERENCES `fitness_club_db`.`members_accounts` (`id_member` , `username`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_have_equipment_statistics` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_have_inbody_analyses` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`nutrition_plan` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`achievements` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_have_achievements` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`news` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`visits_history` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_have_visits_history` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`members_have_training_schedule` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`staff_accounts` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`staff_shedule` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`trainers_accounts` ;
...
CREATE TABLE IF NOT EXISTS `fitness_club_db`.`trainers_accounts` (
  ...
  PRIMARY KEY (`username`, `id_trainer`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fitness_club_db`.`gyms_have_equipment` ;

CREATE TABLE IF NOT EXISTS `fitness_club_db`.`gyms_have_equipment` (
  `gyms_id_gym` INT NOT NULL,
  `gyms_clubs_name` VARCHAR(45) NOT NULL,
  `equipment_id_equipment` INT NOT NULL,
  PRIMARY KEY (`gyms_id_gym`, `gyms_clubs_name`, `equipment_id_equipment`),
  INDEX `fk_gyms_has_equipment_equipment1_idx` (`equipment_id_equipment` ASC) VISIBLE,
  INDEX `fk_gyms_has_equipment_gyms1_idx` (`gyms_id_gym` ASC, `gyms_clubs_name` ASC) VISIBLE,
  CONSTRAINT `fk_gyms_has_equipment_gyms1`
    FOREIGN KEY (`gyms_id_gym` , `gyms_clubs_name`)
    REFERENCES `fitness_club_db`.`gyms` (`id_gym` , `clubs_name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
