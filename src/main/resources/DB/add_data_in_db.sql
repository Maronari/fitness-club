...
("https://yt3.googleusercontent.com/ytc/AGIKgqMqNL53QkVm6XzhngfnDHT51WbNCu-Mz0qj6HPiFw=s900-c-k-c0x00ffffff-no-rj"),
("https://cdn1.tenchat.ru/static/vbc-gostinder/user-picture/42376b1a-86fa-4c47-959e-b7a6f58126a4.jpeg");
...
("DIMKA", 3, 3, "$2a$12$D3H831wG04Q86rXG2fUsBu/1jzUP0mZZkuPTDpospiI5vK9w9Q7UG", "2021-11-05", "2023-11-4", "MEMBER"), /*1234567890*/
("Natali", 4, 4, "$2a$12$vJTX2Fb9/45YXlPcD/dScuPf0L6U1rT6IWmj1JcnQMcPhTGvXxq4W", "2021-11-05", "2023-11-4", "MEMBER"); /*123*/
...
(1, 1, "2024-01-04 14:00:00", 55),
(3, 3, "2024-01-13 14:30:00", 55),
(1, 1, "2024-01-13 17:30:00", 55),
(5, 4, "2024-01-14 15:30:00", 30),
(4, 2, "2024-01-16 18:00:00", 55),
(2, 2, "2024-01-05 10:30:00", 55);
...
insert into nutrition_plan(id_member,nutrition_description,start_date,end_date) values
(1, 'Ежедневный план питания для набора мышечной массы', '2021-10-01',null),
(2, 'План питания для выработки энергии перед тренировкой', '2021-09-05',now()),
(3, 'План питания для поддержания физической активности', '2021-08-01',null),
(4, 'План питания для оптимального восстановления после тренировки', '2021-07-02',null),
(5, 'План питания для снижения жира и поддержания мышечной формы', '2021-06-01',now());
...
(4, 'Анна', 'Павлова', '8800555353', 'anya@example.ru', '2019-11-26', 'Кто-то', 0);
...
(4, "AnnP", "$2a$12$T4u1cWA4TjeEy8BVwtPNKermMEYCKQ8/n6h0L1/NuDfqJwy5a1hW6", current_date(), "2019-06-3", "STAFF"); /*password*/

insert into staff_schedule(id_staff,club_name,weekday,shift) values
(1, 'Авиапарк', '1', '1'),
(1, 'Авиапарк', '2', '2'),
(2, 'Первомайский', '1', '3'),
(3, 'Первомайский', '5', '1'),
...
insert into trainers_accounts (username,password,last_login,account_creation_date,user_role)values
("andrew.kachalkin", "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2ba", current_date(), "2020-12-23", "TRAINER"),
("ivan.stepanov", "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2b1", current_date(), "2020-11-23", "TRAINER"),
("maria.vasilieva", "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2b2", current_date(), "2020-03-23", "TRAINER"),
("anna.smirnova", "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2b3", current_date(), "2020-09-23", "TRAINER"),
('olga.smirnova', "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2b4", current_date(), "2020-01-23", "TRAINER"),
("evgeniy.orlov", "$2y$10$z1VSMQ36/jxstCVWOG5A0uqlLMOIDRTeatfPzkQX6bWNICY9At2b5", current_date(), "2020-06-23", "TRAINER");